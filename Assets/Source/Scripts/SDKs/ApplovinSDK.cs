...
public class ApplovinSDK : Singleton<ApplovinSDK>
{
    private const string MaxSdkKey = "5E98pquotKTFRDvczgKHbaTaBaDkPJxZCP7Nk0xXHA5EfUWNim0ED79n7xHw-DBzogOCpnMaZCCQtQTMmlPKkE";
...
#else // UNITY_ANDROID
    private const string InterstitialAdUnitId = "faaf973d8ea8d945";
    public const string RewardedAdUnitId = "70e4710904167537";
    ...
    private void OnRewardedAdReceivedRewardEvent(string adUnitId, MaxSdk.Reward reward, MaxSdkBase.AdInfo adInfo)
    {
        ...
        GameEvents.CheckTask_E?.Invoke(OnboardingTasks.WatchAd, new OnboardingTaskType[] { OnboardingTaskType.None });
